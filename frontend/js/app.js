  ...
  const info = `
    <div style="padding:20px;text-align:center;direction:rtl">
      ...
      <div style="background:var(--surface-2);border-radius:12px;padding:16px;margin-bottom:12px;text-align:right">
        ...
        <p style="margin:6px 0;display:flex;align-items:center;gap:6px"><strong><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#1877f2"><path d="M24 12.073c0-6.627-5.373-12-12-12S0 5.446 0 12.073c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg> فيسبوك:</strong> <a href="https://www.facebook.com/share/1ECzUUgtqF/?mibextid=wwXIfr" target="_blank" rel="noopener" style="color:var(--primary)">تابعنا على فيسبوك</a></p>
      </div>
